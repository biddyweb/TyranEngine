...
/* Query */
void tyran_value_object_lookup(const struct tyran_value** v, const struct tyran_value* object, const struct tyran_value* key);
void tyran_value_object_lookup_prototype(const struct tyran_value** v, const struct tyran_value* object, const struct tyran_value* key);
