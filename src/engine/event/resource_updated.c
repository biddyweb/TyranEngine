...
void nimbus_resource_updated_send(nimbus_event_write_stream* out_event_stream, nimbus_resource_id resource_id, nimbus_resource_type_id resource_type_id, void* data, int payload_size)
{
	...
	TYRAN_LOG("Sending resource updated. %d of type %d", resource_id, resource_type_id);
