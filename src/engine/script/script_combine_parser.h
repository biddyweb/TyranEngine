...
void nimbus_script_combine_parser_init(nimbus_script_combine_parser* self, struct nimbus_modules* modules, struct tyran_symbol_table* symbol_table, struct nimbus_combine* combine, const struct tyran_object* combine_script_object, nimbus_resource_id resource_id);
