...
void nimbus_resource_cache_add(nimbus_resource_cache* self, nimbus_resource_id resource_id, struct tyran_value* value);
struct tyran_value* nimbus_resource_cache_find(nimbus_resource_cache* self, nimbus_resource_id resource_id);
struct tyran_value* nimbus_resource_cache_get(nimbus_resource_cache* self, nimbus_resource_id resource_id);
