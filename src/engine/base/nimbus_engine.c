...
{
	nimbus_event_definition* touch_began = nimbus_modules_add_event(modules, "touch_began", NIMBUS_EVENT_TOUCH_BEGAN_ID);
	...
	nimbus_event_definition* touch_moved = nimbus_modules_add_event(modules, "touch_moved", NIMBUS_EVENT_TOUCH_MOVED_ID);
	...
	nimbus_event_definition* touch_ended = nimbus_modules_add_event(modules, "touch_ended", NIMBUS_EVENT_TOUCH_ENDED_ID);
	...
	nimbus_event_definition* touch_stationary = nimbus_modules_add_event(modules, "touch_stationary", NIMBUS_EVENT_TOUCH_STATIONARY_ID);
