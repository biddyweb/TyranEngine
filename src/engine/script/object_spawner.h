...
void nimbus_object_spawner_init(nimbus_object_spawner* self, struct tyran_runtime* runtime, struct nimbus_event_definition* defintions, int definitions_count, const struct tyran_object* object_to_spawn);
